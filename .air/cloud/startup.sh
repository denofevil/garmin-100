...
chrome_env_exports() {
  cat <<EOF
# Generated by .air/cloud/startup.sh -- sourced from the login shell and
# ~/.bashrc, so every path append below is guarded against running twice.
export CHROME_DEPS_DIR="$CHROME_DEPS_DIR"
case ":\${LD_LIBRARY_PATH:-}:" in
  *":$CHROME_DEPS_DIR/usr/lib/x86_64-linux-gnu:"*) ;;
